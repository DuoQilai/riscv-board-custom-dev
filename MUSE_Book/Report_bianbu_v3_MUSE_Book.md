# bianbu (v3) MUSE Book 系统版本和工具链测试报告
...
- MUSE Book
  ...
  - 设备型号截图
    ...
    ![device-model](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/device-model.png)

  - 系统信息截图

    ![device-cpuinfo](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/device-cpuinfo.png)
...
3. 用USB Type-C数据线连接MUSE Book左侧靠近3.5mm耳机接口的Type-C接口与PC；

4. 用牙签/取卡针按住笔记本右侧的fastboot按钮，保持按压状态，同时按键盘上的开机键开机；
...
![gnu-hello-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/gnu-hello-compile.png)

![gnu-hello-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/gnu-hello-run.png)
...
![gnu-coremark-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/gnu-coremark-compile.png)

![gnu-coremark-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/gnu-coremark-run.png)
...
![llvm-hello-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/llvm-hello-compile.png)

![llvm-hello-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/llvm-hello-run.png)
...
![llvm-coremark-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/llvm-coremark-compile.png)

![llvm-coremark-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/MUSE_Book/images/llvm-coremark-run.png)
...
[![asciicast](https://asciinema.org/a/777475.svg)](https://asciinema.org/a/777475)
...
1. **系统初始化结果**  
   已完成MUSE Book开发板系统镜像的烧录与部署，开发板可正常启动并完成开机向导配置，通过终端成功登录系统，系统运行稳定，网络连接正常，满足测试需求。
