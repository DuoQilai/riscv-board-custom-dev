# bianbu (v3) Milk-V Jupiter 系统版本和工具链测试报告
...
-  Milk-V Jupiter
  ...
  - 设备型号截图
    ...
    ![device-model](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/device-model.png)

  - 系统信息截图

    ![device-cpuinfo](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/device-cpuinfo.png)
...
3. 使用Type-C数据线连接开发板与PC，按住开发板CPU附近的RECOVERY按键，同时插入12V电源
...
1. 断开开发板与PC的连接，依次为开发板连接HDMI线（对接显示器）、键盘、网线，最后接入12V DC电源适配器
...
![gnu-hello-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/gnu-hello-compile.png)

![gnu-hello-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/gnu-hello-run.png)
...
make CC=riscv64-plct-linux-gnu-gcc XCFLAGS="-march=rv64imafdcv_zicbom_zicboz_zicntr_zicond_zicsr_zifencei_zihintpause_zihpm_zfh_zfhmin_zca_zcd_zba_zbb_zbc_zbs_zkt_zve32f_
zve32x_zve64d_zve64f_zve64x_zvfh_zvfhmin_zvkt_sscofpmf_sstc_svinval_svnapot_svpbmt" compile

./coremark.exe
```

![gnu-coremark-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/gnu-coremark-compile.png)

![gnu-coremark-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/gnu-coremark-run.png)
...
![llvm-hello-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/llvm-hello-compile.png)

![llvm-hello-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/llvm-hello-run.png)


编译coremark（LLVM）

```bash
cd coremark; make clean; make CC=clang XCFLAGS="-march=rv64imafdcv_zicbom_zicboz_zicntr_zicond_zicsr_zifencei_zihintpause_zihpm_zfh_zfhmin_zca_zcd_zba_zbb_zbc_zbs_zkt_zve32f_
zve32x_zve64d_zve64f_zve64x_zvfh_zvfhmin_zvkt_sscofpmf_sstc_svinval_svnapot_svpbmt" compile

./coremark.exe
```

![llvm-coremark-compile](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/llvm-coremark-compile.png)

![llvm-coremark-run](https://github.com/zhiyao310/riscv-board-custom-dev/blob/main/Jupiter/images/llvm-coremark-run.png)
...
[![asciicast](https://asciinema.org/a/777474.svg)](https://asciinema.org/a/777474)
...
1. **系统初始化结果**  
   已完成Milk-V Jupiter开发板系统镜像的烧录与部署，开发板可正常启动并完成开机向导配置，通过终端成功登录系统，系统运行稳定，网络连接正常，满足测试需求。
